...
// Function to generate apache-specific timestamp format
...
function generateLog(req, res, startTime, options) {
    var params = getLogParameters(req, res, startTime, options),
        ...
        clfTimeStamp = generateCLFTimestamp(params.timeStamp);
    ...
    switch(format.toLowerCase()) {
        case 'combined':
            ...
            */
            ...
            return params.ip + " - - [" + clfTimeStamp + "] \"" + params.method + " " + params.url + " HTTP/" + params.httpVersion + "\" " + params.statusCode + " " + contentLength + " " + referrer + " \"" + params.userAgent + "\"\n";
        ...
        case 'common':
            ...
            */
            ...
            return params.ip + " - - [" + clfTimeStamp + "] \"" + params.method + " " + params.url + " HTTP/" + params.httpVersion + "\" " + params.statusCode + " " + contentLength + "\n";
