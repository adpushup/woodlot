...
var auth = require('basic-auth'),
    ...
    colorizeStatusCode = require('./utils').colorizeStatusCode;
...
function generateLog(req, res, startTime, config) {
    ...
    var apacheBaseFormat = params.ip + " - " + userId + " [" + clfTimeStamp + "] \"" + params.method + " " + params.url + " HTTP/" + params.httpVersion + "\" " + colorizeStatusCode(params.statusCode) + " " + contentLength;
