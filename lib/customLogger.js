...
function customLogLevel(level, message) {
...
var customLogger = {
    ...
    info: function(message) {
        customLogLevel('info', message);
    },
    debug: function(message) {
        customLogLevel('debug', message);
    },
    warn: function(message) {
        customLogLevel('warning', message);
    },
    error: function(message) {
        customLogLevel('error', message);
    }
};
